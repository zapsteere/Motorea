      ...
      <main className="layout-radius">
        ...
        <section className="boxcar-container pt-16 pb-10">
          ...
          <p className="text-lg max-w-3xl">
            We source, prepare, and deliver quality used cars across the UK. No faff. No hidden fees. Cars match the
            description — or they don’t leave our site.
          </p>
        </section>
        ...
        <section className="boxcar-container py-10">
          ...
          <ol className="list-decimal pl-6 space-y-2 max-w-3xl">
